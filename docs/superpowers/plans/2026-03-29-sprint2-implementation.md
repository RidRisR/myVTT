...
- [ ] **Step 1: Remove total from server roll-request handler**
...
- [ ] **Step 2: Remove total from LogPayloadMap['core:roll-result']**
...
- [ ] **Step 1: Add groupId to type definitions**
...
- [ ] **Step 2: Add group_id column to schema**
...
- [ ] **Step 1: Write tests for groupId auto-injection**
...
- [ ] **Step 3: Add ChainContext to context options**
...
- [ ] **Step 4: Extend IWorkflowRunner with ChainContext**
...
- [ ] **Step 5: Update WorkflowRunner to pass ChainContext**
...
- [ ] **Step 1: Write test for causedBy propagation**
...
- [ ] **Step 2: Update LogStreamDispatcher to pass ChainContext**
...
- [ ] **Step 3: Update initWorkflowSystem dispatcher creation**
...
- [ ] **Step 1: Inline roll logic into quick-roll**
...
- [ ] **Step 2: Update dh:action-check to use direct serverRoll**
...
- [ ] **Step 3: Remove getRollWorkflow from exports**
...
- [ ] **Step 1: Add dh:judgment to LogPayloadMap**
...
- [ ] **Step 2: Add emit step to dh:action-check**
...
- [ ] **Step 3: Remove announceEvent from display step**
...
- [ ] **Step 1: Write RendererRegistry tests**
...
- [ ] **Step 4: Add registerRenderer to IUIRegistrationSDK**
...
- [ ] **Step 1: Refactor DiceAnimContent props**
...
- [ ] **Step 2: Create CardShell component**
...
- [ ] **Step 5: Register base renderers**
...
- [ ] **Step 1: Create DHJudgmentRenderer**
...
- [ ] **Step 2: Register renderer in plugin activation**
...
- [ ] **Step 1: Create LogEntryCard with fallback**
...
- [ ] **Step 2: Migrate MessageScrollArea to GameLogEntry[]**
...
- [ ] **Step 3: Migrate ToastStack to GameLogEntry[]**
