                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <Popover.Portal>
                        ...
                        >
                          <p className="text-xs text-text-primary mb-2.5 whitespace-nowrap">{`Delete "${archive.name}"?`}</p>
        ...
        {selectedArchive && (
          ...
          >
            ...
            <Popover.Portal>
              ...
              >
                <p className="text-xs text-text-primary mb-2.5 whitespace-nowrap">{`Load "${selectedArchive.name}"? Current battlefield will be replaced.`}</p>
                <div className="flex justify-end gap-2">
                  <button
                    onClick={() => {
                      setLoadingId(null)
