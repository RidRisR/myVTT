...
const COLORS = ['#22c55e', '#3b82f6', '#8b5cf6', '#f59e0b', '#06b6d4', '#ec4899', '#ef4444', '#f97316']
          ...
          <div key={t.id} style={{ marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginBottom: 4 }}>
              <input
                ...
                placeholder="Name"
                style={{ ...inputStyle, flex: 1, fontSize: 11, padding: '4px 6px', fontWeight: 600 }}
              />
              <input
                ...
                style={{ ...inputStyle, width: 32, textAlign: 'center', fontSize: 11, padding: '4px 2px', fontWeight: 700 }}
              />
              ...
              <input
                ...
                onBlur={(e) => {
                  const v = parseInt(e.target.value)
                  if (!isNaN(v) && v > 0) onUpdateTracker(t.id, { max: v, current: Math.min(t.current, v) })
              ...
              <button
                ...
                style={{
                  ...
                  padding: 2, lineHeight: 1, flexShrink: 0,
            ...
            {colorPickerOpen === t.id && (
              <div ref={colorPickerRef} style={{ display: 'flex', gap: 4, marginTop: 6, justifyContent: 'center' }}>
                {COLORS.map(c => (
                  <div
                    key={c}
                    onClick={() => { onUpdateTracker(t.id, { color: c }); setColorPickerOpen(null) }}
                    style={{
